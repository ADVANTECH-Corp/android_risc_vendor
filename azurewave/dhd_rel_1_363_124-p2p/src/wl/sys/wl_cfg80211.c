 ...
 *
 * $Id: wl_cfg80211.c 607597 2015-12-21 12:21:22Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
...
#if defined(CUSTOM_PLATFORM_NV_TEGRA) || defined(CUSTOMER_HW5)
...
#endif /* defined(CUSTOM_PLATFORM_NV_TEGRA) || defined(CUSTOMER_HW5) */
