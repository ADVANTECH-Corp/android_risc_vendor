 ...
 *
 * $Id: dhd.h 606703 2015-12-16 12:22:50Z $
 */
...
/* Disable common flowring list spinLock/Unlock when perimeter lock is in use */
#define DHD_FLOWRING_LIST_LOCK(lock, flags)      ({ BCM_REFERENCE(flags); })
#define DHD_FLOWRING_LIST_UNLOCK(lock, flags)    ({ BCM_REFERENCE(flags); })
